...
git clone git@github.com:mbta/onebusaway-gtfs-modules.git --depth 1 -b lev-support-for-pathways
pushd onebusaway-gtfs-modules
mvn clean install -Dmaven.test.skip=true -Dlicense.skip=true
popd

rm -rf OpenTripPlanner
git clone git@github.com:mbta/OpenTripPlanner.git --depth 1 -b lev-new-pathways
