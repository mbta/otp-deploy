...
ARG MAX_SEARCH_WINDOW
ENV MAX_SEARCH_WINDOW="$MAX_SEARCH_WINDOW"
ARG REMOVE_ITINERARIES_WITH_SAME_ROUTES_AND_STOPS
...
ARG URL_ALERTS
ENV URL_ALERTS="$URL_ALERTS"
ARG URL_TRIP_UPDATES
ENV URL_TRIP_UPDATES="$URL_TRIP_UPDATES"
ARG URL_VEHICLE_POSITIONS
ENV URL_VEHICLE_POSITIONS="$URL_VEHICLE_POSITIONS"
